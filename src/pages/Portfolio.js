  ...
  return (
    ...
    >
      ...
      <div className="portfolio-content" style={lightThemeStyle}>
        ...
        {
          portfolio.about && (
            <section className="section about-section" style={{
              width: '100vw',
              position: 'relative',
              left: '50%',
              right: '50%',
              ...
              <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
                <h2 className="section-title" style={{ paddingLeft: '20px' }}>About Me</h2>
                <div className="about-card" style={{ maxWidth: '100%', margin: '0 20px' }}>
        ...
        {/* Skills Section */}
        {
          portfolio.skills && portfolio.skills.length > 0 && (
            <section className="section skills-section" style={{
              width: '100vw',
              position: 'relative',
              left: '50%',
              right: '50%',
              ...
              <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
                <h2 className="section-title" style={{ paddingLeft: '20px' }}>Technical Skills</h2>
                <div className="skills-grid" style={{ padding: '0 20px' }}>
        ...
        {/* Projects Section */}
        {
          ...
          portfolio.projects[0].name && (
            <section className="section projects-section" style={{
              width: '100vw',
              position: 'relative',
              left: '50%',
              right: '50%',
              marginLeft: '-50vw',
              marginRight: '-50vw',
              padding: '0 5%' // Add some side padding for aesthetics
            }}>
              <div style={{ maxWidth: '1400px', margin: '0 auto' }}> {/* Inner container to keep title aligned if needed, or remove for full full width */}
                <h2 className="section-title" style={{ paddingLeft: '20px' }}>Projects</h2>
        ...
        {/* Experience Section */}
        {
          ...
          portfolio.experience[0].title && (
            <section className="section experience-section" style={{
              width: '100vw',
              position: 'relative',
              left: '50%',
              right: '50%',
              ...
              <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
                <h2 className="section-title" style={{ paddingLeft: '20px' }}>Experience</h2>
                <div className="experience-grid" style={{ padding: '0 20px' }}>
        ...
        {/* Connect Section */}
        <section className="section connect-section" style={{
          width: '100vw',
          position: 'relative',
          left: '50%',
          right: '50%',
          ...
          <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
            <h2 className="section-title" style={{ paddingLeft: '20px' }}>Connect With Me :)</h2>
            <div className="social-links" style={{ paddingBottom: '40px' }}>
            ...
            <div style={{
              ...
              >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M18 8C19.6569 8 21 6.65685 21 5C21 3.34315 19.6569 2 18 2C16.3431 2 15 3.34315 15 5C15 5.12548 15.0077 15.2491 15.0227 15.3711L8.08259 11.9012C7.54305 11.3117 6.81099 10.9545 6 10.9545C4.34315 10.9545 3 12.2977 3 13.9545C3 15.6114 4.34315 16.9545 6 16.9545C6.81099 16.9545 7.54305 16.5974 8.08259 16.0078L15.0227 19.4778C15.0077 19.5998 15 19.7236 15 19.8491C15 21.5059 16.3431 22.8491 18 22.8491C19.6569 22.8491 21 21.5059 21 19.8491C21 18.1922 19.6569 16.8491 18 16.8491C17.189 16.8491 16.457 17.2062 15.9174 17.7958L8.97733 14.3258C8.99229 14.2038 9 14.08 9 13.9545C9 13.829 8.99229 13.7053 8.97733 13.5833L15.9174 10.1133C16.457 10.7029 17.189 11.06 18 11.06C19.6569 11.06 21 9.71685 21 8.06C21 6.40315 19.6569 5.06 18 5.06V8Z" fill="white" />
                </svg>
              </button>
